...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Campos de Nota Fiscal e CondiÃ§Ã£o 14.1 foram removidos do cadastro manual

    // Se nÃ£o hÃ¡ erros, inserir no banco
    if (empty($erros)) {
        try {
            ...
            // Inserir mÃºltiplos produtos conforme o multiplicador (agora na tabela produtos)
            // Campos padrÃ£o para novo cadastro: novo=1, checado=1, imprimir_etiqueta=1, editado=0, ativo=1
            ...
            for ($i = 0; $i < $multiplicador; $i++) {
                // Montar descriÃ§Ã£o completa (quantidade sempre serÃ¡ 1)
                ...
                // DefiniÃ§Ã£o padrÃ£o para satisfazer NOT NULL no banco (campo nÃ£o Ã© usado no cadastro manual)
...
// FunÃ§Ã£o para gerar parÃ¢metros de filtro (similar Ã  do read)
