...
try {
    $sql = "UPDATE produtos SET editado_tipo_bem_id = 0, editado_bem = '', editado_complemento = '', editado_dependencia_id = 0, editado_descricao_completa = '', editado = 0, imprimir_etiqueta = 0 WHERE id_produto = :produto_id AND comum_id = :comum_id";
