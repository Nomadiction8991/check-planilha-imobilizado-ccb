        ...
        <div class="card-body">
            ...
            <div class="radio-card" data-value="2" onclick="selecionarCondicao(2)">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <label for="condicao2"><strong>OpÃƒÂ§ÃƒÂ£o 2:</strong> O bem tem mais de cinco anos de uso, porÃƒÂ©m o documento fiscal de aquisiÃƒÂ§ÃƒÂ£o foi extraviado.</label>
                </div>
            </div>
            <div class="radio-card" data-value="3" onclick="selecionarCondicao(3)">
                <div class="d-flex align-items-start gap-3">
                    <input type="radio" name="condicao_14_1" id="condicao3" value="3">
                    <label for="condicao3"><strong>OpÃƒÂ§ÃƒÂ£o 3:</strong> O bem tem atÃƒÂ© cinco anos de uso e o documento fiscal de aquisiÃƒÂ§ÃƒÂ£o estÃƒÂ¡ anexo.</label>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label">NÃƒÂºmero da Nota <span class="text-danger">*</span></label>
...
// Se todos assinados nÃƒÂ£o hÃƒÂ¡ seleÃƒÂ§ÃƒÂ£o de condiÃƒÂ§ÃƒÂ£o
<?php if($todos_assinados): ?>
